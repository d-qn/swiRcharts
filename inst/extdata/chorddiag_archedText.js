HTMLWidgets.widget({
  ...
  renderValue: function(el, params, chord) {
    ...
    if (showTooltips) {
        ...
        var groupTip = d3.tip()
                         ...
                         .html(function(d) {
                             ...
                             return tooltipNames[d.index] + ": " + value + tooltipUnit;
                         });
    }
    ...
    if (showGroupnames) {
        ...
        //  ------- !!!!!!!!!!!!!!!!!!!! From http://www.visualcinnamon.com/2015/09/placing-text-on-arcs.html to write arched text --------------------------------!!!!

    names.append("text")
    .attr("x", 5)   //Move the text from the start angle of the arc
    .attr("dy", 18) //Move the text down
       .append("textPath")
       .attr("xlink:href", function(d) {return "#group-" + d.label;})
      .text(function(d) { return d.label; })
