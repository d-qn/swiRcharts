...
##' @param output a path to a folder where the output html file and depending js libraries will be saved
...
##' TO DO !!!!!!
##' }
swi_widget <- function(widget.html, output.html = "parset_swi.html", output = ".",
  source = "source:",
  ...
  ## copy the javacript parset.css file
